...
@section('content')
  ...
  <section class="min-vh-100 mb-8">
    <div class="page-header align-items-start min-vh-50 pt-5 pb-11 mx-3 my-3 border-radius-lg" style="background-image: url('{{ asset('assets/img/curved-images/bg-2.png') }}');">
          ...
          <div class="card z-index-0">
            ...
            <div class="card-body">
              <form role="form text-left" method="POST" action="{{ route('organization.register-store') }}">
                ...
                <p class="text-sm mt-3 mb-0">Already have an account? <a href="{{ route('organization.login.link', $organization->token) }}" class="text-info text-gradient font-weight-bolder">Sign in</a></p>
              </form>
            </div>
          </div>
        </div>
